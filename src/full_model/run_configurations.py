...
RUN = 16
RUN_COMMENT = """Train full model for 1 epoch with pre-trained weights from run 14 (weights of 5 for binary classifiers), CA enabled. Weight of 2 for language model loss."""
